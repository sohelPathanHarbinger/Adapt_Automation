...
export default function Image(props) {
  ...
  const isTopTitle = props.attributionOnTop && props.attribution?" img-title-on-top":"";
  ...
  const attribution = props.attribution && (
    <span className={prefixClasses(attributionClassNamePrefixes, ['__attribution'],isTopTitle)}>
  ...
  return (
    ...
    >
      {props.attributionOnTop && attribution}
