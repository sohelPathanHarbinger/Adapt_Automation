...
const AssessmentModel = {
  ...
  _onAssessmentComplete() {
    ...
    console.log("is assessment complete ", _scoreAsPercent >= assessmentConfig?._scoreToPass ? true : false)
    this.set({
      _scoreAsPercent,
      _score,
      _maxScore,
      ...
      //custom change made as per client requirement 
      _isAssessmentComplete: _scoreAsPercent >= assessmentConfig?._scoreToPass ? true : false
    });
    this._updateQuestionsState();
    this._checkIsPass();
    this._removeQuestionListeners();
